...
public class CalculadoraEstadisticas
{
	...
	/**
	 * MODIFICACIÓN AGREGADA: Retorna el pais con el nombre del atleta indicado
	 * 
	 */
	public String PaisporNombredelAtleta(String nombreAtleta)
	{
		Atleta elAtleta = null;
		String elpais = "No pertenece";
		
		for (int i = 0; i < atletas.size() ; i++)
		{
			elAtleta = atletas.get(i);
			if (elAtleta != null)
				if (elAtleta.darNombre().equals(nombreAtleta))
