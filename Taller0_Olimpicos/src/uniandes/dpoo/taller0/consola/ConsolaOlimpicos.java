...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais con el nombre de un atleta");
	...
	/**
	 * OPCIÓN AGREGADA (TALLER 0): Le pide al usuario el nombre de un atleta y luego le muestra la información de
	 * el país al que pertenece dicho atleta. 
	 */
	private void ejecutarPaisdelAtleta()
	{
		System.out.println("\n" + "El nombre del pais el cual representa el atleta" + "\n");

		String nombre = input("Por favor ingrese el nombre de un atleta");
		
		String pais = calculadora.PaisporNombredelAtleta(nombre);
	
		System.out.println("El nombre del pais el cual representa el atleta: "+ nombre + " es: " + pais);
